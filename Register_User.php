                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
								...
								if($_POST){
                                    ...
                                    $sql = "SELECT * from khach_hang where Email='$user_name' and Password='$user_pass'";
                                    ...
                                    <form class="user" action="Register_User.php" method="post">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                ...
                                                placeholder="Enter Email Address..." name="user_name" value="<?php if(isset($_POST['user_name'])) echo $_POST['user_name']; ?>">
                                        </div>
                                        <div class="form-group">
